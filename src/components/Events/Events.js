            ...
            <section className="events-section">   
                ...
                <div className="container-events"> 
                    <div className="event wedding-event">
                        <div className="image-block image-church">
                            <img className="event-image pic-church" src={Church} alt="St Marys Img"/>
                        </div>
                    ...
                    <div className="event reception-event">
                        <div className="image-block image-walker">
                            <img className="event-image pic-walker" src={Walker} alt="Walker Homestead Img"/>
                        </div>
